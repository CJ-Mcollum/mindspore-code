...
#数据路径
dataset_path = r"F:\dataset\Lung-nodules\exp_nodules\train_val_test\nodules_cascade_tvt\tag_crop64_ms\nodules_ground_solid_exp_tvt_ms"
...
model_save_path = "./model/tvt/ground_solid_best.ckpt"
num_epochs = 1
batch_size_num = 24
...
def val_main(num_epochs, model_save_path):
    ...
    visualize_model(model_save_path, val_ds)


if __name__ == '__main__':
    val_main(num_epochs, model_save_path)