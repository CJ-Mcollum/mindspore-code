...
# modify by liuziang 2023.1.8 更改数据集目录路径
# __C.DATA_DIR = '../MindSpore_dataset' #划分好的数据集
__C.DATA_DIR = '../vessel_data'
...
__C.SUMMARY_DIR = './summary_log/unet++_0907'#存储summary_wirter信息,进行可视化
__C.OUTPUT_DIR = './output_train/unet++_0907'#输出训练好的模型
