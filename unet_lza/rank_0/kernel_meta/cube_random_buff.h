...
__ca__   uint8_t* dst_l0a = (__ca__  uint8_t *)get_imm(0);
  ...
  for (int32_t k = 0; k < 4; ++k) {
    copy_ubuf_to_cbuf(((__cbuf__ half *)dst_l1 + ((k * 126976) + (((int32_t)reg_buf8[0]) * 16))), ((__ubuf__ half *)src_ub + (((int32_t)reg_buf8[0]) * 16)), 0, 800, 1, 8, 8);
  }
